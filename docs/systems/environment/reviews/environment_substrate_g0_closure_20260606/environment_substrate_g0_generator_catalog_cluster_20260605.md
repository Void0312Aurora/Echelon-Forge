...
| `G0-K-D Integration Map` | main thread integration | n/a | Integrate A/B/C packets into a finite G0-K implementation plan. | `docs/systems/environment/reviews/environment_substrate_g0_closure_20260606/*.md`, parent ground README/progress/queue docs | No runtime projection, no C++ runtime, no scenarios, no derived products. | Local review of packets plus `git diff --check` for touched docs. | Implementation write set named and residuals preserved. | Serial after G0-K-A/B/C return. | 1 | pass |
