...
- 同一文件也存在于 Godot 归档：`archive/20260530_game_godot_local_archive/game/client/godot_project/assets/models/f16.glb`（本地专用、不入库）
...
- `Temp/Model/resource.md`（本地专用、不入库） 只记录了 DDG、Patuxent、低多边形导弹等来源，没有记录 F-16。
