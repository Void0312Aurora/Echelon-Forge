...
does not edit [f16c_block50.json](../../../../../examples/config/database/aircraft/units/f16c_block50.json),
...
R3 also completed a local `64`-step runtime/training smoke, R4 completed the
active 8k proxy-versus-baseline comparison while preserving the default `26`
component control path, and R5 has since completed targeted damage-event trace:
...
git diff --check -- docs/systems/effects/reviews/f16c_target_geometry_20260614 tools/geometry/airframe_geometry_review.py tests/tools/test_airframe_geometry_review.py src/tests/test_components_basic.cpp
```
