...
training probe result, TG-P7-R5 damage-event trace result, and TG-P7-R6 32k
...
active 8k training comparison, a TG-P7-R5 targeted trace, and a TG-P7-R6 active
32k proxy/baseline training comparison. All `8` split receivers are observable
in proxy component event names, and both 32k runs complete, but default active
runtime projection remains unchanged. The later whole-airframe projected mesh
contour diagnostic is a tooling-method upgrade; after the R22 shape-aware
thin-prism/frustum corrections it records `0` receiver-prior protrusions and
...
| TG-P4 review packet | [scene.html](review_packets/f16c_20260611/scene.html), [whole_airframe_contour_dashboard.html](review_packets/f16c_20260611/whole_airframe_contour_dashboard.html) | Current packet is contracted to the final projected mesh contour result; the old draft three-view SVG entrypoints are retired |
...
| TG-P6 mesh-derived fine-proxy silhouettes | [fine_geometry_proxy_candidate_20260611.json](review_packets/f16c_20260611/fine_geometry_proxy_candidate_20260611.json) | Generated `14` review-only proxies with top/side/front convex hull silhouettes from `13,415` audit glTF vertices; nose, canopy, wing, and horizontal-tail regions now use audit-mesh placement and source-node whitelists; `inflated_fallback_count=0`, support volume ratio is `0.55404`; visual pages are raw intermediate evidence, not current result entrypoints |
| TG-P6 human review dashboard | retired intermediate view | Per-region cards showed local top/side/front views with source bounds, support bounds, mesh silhouette, component boxes, node-selection strategy, disabled fallback policy, flags, and candidate/review status; this HTML surface is no longer a current result entrypoint |
...
| TG-P6 visual triage | retired intermediate view | Grouped review items by coordinate sign, component placement, surface handoff, and review-point sanity; this HTML surface is no longer a current result entrypoint |
| TG-P6 semantic damage geometry candidates | [semantic_damage_geometry_candidate_20260611.json](review_packets/f16c_20260611/semantic_damage_geometry_candidate_20260611.json), [semantic_damage_geometry_candidate_20260611.csv](review_packets/f16c_20260611/semantic_damage_geometry_candidate_20260611.csv) | R12 emits `14` semantic outer-shell volume candidates and `14` `runtime_component_json_candidate` records; runtime schema/loader can parse the geometry fields, `8` handoffs remain cross-region held, and `runtime_active_component_count=0`; generated visual pages are raw intermediate evidence |
| TG-P6 internal receiver prior geometry | [internal_component_prior_candidate_20260611.json](review_packets/f16c_20260611/internal_component_prior_candidate_20260611.json), [internal_component_prior_candidate_20260611.csv](review_packets/f16c_20260611/internal_component_prior_candidate_20260611.csv) | R13 generates review-only internal receiver priors for all `26` current receivers and constrains them by parent shell support bounds or cross-region unions; current shape counts are `capsule=9`, `ellipsoid=7`, `frustum=1`, `obb=6`, and `thin_prism=3`; `post_constraint_outside_count=0`, `cross_region_held_prior_count=2`, `runtime_active_component_count=0`; generated visual pages are raw intermediate evidence |
| TG-P6 semantic parent-child layout | [semantic_parent_child_layout_candidate_20260611.json](review_packets/f16c_20260611/semantic_parent_child_layout_candidate_20260611.json), [semantic_parent_child_layout_candidate_20260611.csv](review_packets/f16c_20260611/semantic_parent_child_layout_candidate_20260611.csv) | R14 makes the `14` parent shell parts the primary review views and overlays all `26` receiver priors on their parent pages; R15 draws cross-region held receivers as split red segments instead of monolithic held blocks; generated visual pages are raw intermediate evidence |
| TG-P6 cross-region held segment split | [cross_region_held_component_segments_20260611.json](review_packets/f16c_20260611/cross_region_held_component_segments_20260611.json), [cross_region_held_component_segments_20260611.csv](review_packets/f16c_20260611/cross_region_held_component_segments_20260611.csv) | R15 splits `engine_core` into `3` review-only engine segments and `wing_spar_center` into `5` review-only spar segments; `held_segment_count=8`, `outside_whole_airframe_segment_count=0`, `runtime_active_segment_count=0`, and cross-region ownership remains held |
...
| TG-P6 airframe constraint correction candidates | [airframe_constraint_correction_candidate_20260611.json](review_packets/f16c_20260611/airframe_constraint_correction_candidate_20260611.json), [airframe_constraint_correction_candidate_20260611.csv](review_packets/f16c_20260611/airframe_constraint_correction_candidate_20260611.csv) | R16/R18 checks all `34` receiver priors / held split segments as a raw shape-aware top/side/front whole-airframe silhouette diagnostic. After the R22 shape-aware thin-prism/frustum corrections, current raw output records `silhouette_exposure_item_count=0`, `size_or_shape_review_item_count=0`, and `runtime_active_component_count=0`; held split segments are excluded from the final contour result surface. |
| TG-P6 subcomponent shape-placement candidates | [subcomponent_shape_placement_candidate_20260611.json](review_packets/f16c_20260611/subcomponent_shape_placement_candidate_20260611.json), [subcomponent_shape_placement_candidate_20260611.csv](review_packets/f16c_20260611/subcomponent_shape_placement_candidate_20260611.csv) | R17 creates nominal-dimension-preserving candidate shape families; R18 promotes the first `4` zero-exposure candidates; R19 adds local centerline candidates; R20 resolves the radar/cockpit leftovers; R21 promotes the accepted latest placements into review-only rules. After the R22 thin-prism/frustum corrections, the current source exposure queue is empty: `shape_placement_candidate_count=0`, `source_silhouette_exposure_item_count=0`, and `runtime_active_component_count=0`; generated visual pages are raw intermediate evidence. |
...
| TG-P6 latest subcomponent promotion implementation | [subcomponent_latest_promotion_results_20260613.md](subcomponent_latest_promotion_results_20260613.md) | R21 promotes the latest accepted placements into review-only prior and held-segment generation rules: `internal_component_prior_shape_promotion_count=9`, `cross_region_held_segment_shape_promotion_count=5`, and runtime activation remains `0`. Its `airframe_constraint_silhouette_exposure_item_count=0` was a pre-projected-mesh-contour snapshot, superseded for current containment by the whole-airframe contour row below. |
...
| TG-P7 training proxy database implementation | [target_geometry_training_proxy_results_20260613.md](target_geometry_training_proxy_results_20260613.md), [target_geometry_training_proxy_database_20260613.json](review_packets/f16c_20260611/target_geometry_training_proxy_database_20260613.json), [target_geometry_training_proxy_database_20260613/](review_packets/f16c_20260611/target_geometry_training_proxy_database_20260613.json) | TG-P7-R3 materializes a full opt-in proxy runtime database and active training config: default database components `26`, proxy database components `32`, split receivers active in proxy `8`, duplicate names `0`, `runtime.database_path` wired through training bootstrap and `train.py`, repository unit database modified `false`, RuntimeFacade proxy database load passes, and local `64`-step CPU training smoke completes |
...
| TG-P7 32k opt-in training probe | [target_geometry_training_probe_32k_results_20260614.md](target_geometry_training_probe_32k_results_20260614.md), [target_geometry_training_probe_32k_20260614.json](review_packets/f16c_20260611/target_geometry_training_probe_32k_20260614.json) | TG-P7-R6 completes active `32768`-step CUDA `WorldBatchVecEnv` runs for both proxy and baseline configs. Proxy final `ep_len_mean=619.00`, `ep_rew_mean=-401.05`; baseline final `ep_len_mean=609.02`, `ep_rew_mean=-271.04`. Both write checkpoints and final models under `/tmp/cmo_tg_p7_r6_32k_probe`; the baseline has no database override |
| Stage-C guard alignment | Historical implementation: `git show c0e4f31f:tools/maintenance/candidate_artifacts/component_probability_surface_probe.py` | The repaired beam-side component geometry yielded `surface_incidence_cos=0.0`; the closed Stage-C candidate producer was later retired after its runtime authority invariant moved to a test-local fixture |
| Whole-airframe projected mesh contour containment | [whole_airframe_contour_containment_results_20260614.md](whole_airframe_contour_containment_results_20260614.md), [whole_airframe_contour_containment_results_20260614.zh.md](whole_airframe_contour_containment_results_20260614.zh.md), [whole_airframe_contour_containment_20260614.json](review_packets/f16c_20260611/whole_airframe_contour_containment_20260614.json), [whole_airframe_contour_top.svg](review_packets/f16c_20260611/whole_airframe_contour_top.svg), [whole_airframe_contour_dashboard.html](review_packets/f16c_20260611/whole_airframe_contour_dashboard.html) | The silhouette-containment test now projects `4,504` audit glTF triangles into each view and unions those projected faces (`contour_method=projected_mesh_triangle_union`) before applying shape-aware projected sampling and a `0.05 m` engineering review margin. The final result surface contains only the `26` current receiver priors, excludes `8` review-only held split segments, and records `0` items exceeding tolerance (`max_outside_distance_m=0.0`). The two wing fuel cells are swept thin-prism planform footprints, `wing_spar_center` is a symmetric thin-prism carry-through strip, and `afterburner_nozzle` is a tapered frustum. This is a tooling-method upgrade, not a change to the F-16C fine-geometry acceptance. |
...
- This status proves only that the TG-P1 source/scale manifest, TG-P2
  ...
  first visual findings, five subagent
...
- Runtime near-fuze projection remains unchanged on the default path. TG-P7-R6
  keeps the feature-flagged `damage_model.hitboxes[].components` projection
  ...
  event-trace coverage. TG-P7-R6 additionally proves that the opt-in proxy and
  default baseline can both complete same-budget `32768`-step training probes,
  but the final diagnostics windows still show combat-action fractions of
  `0.0`; this is not a learned weapon-employment or default-replacement claim.
...
passed`, with all `8` split receivers observed in proxy event names; TG-P7-R6
32k proxy and baseline CUDA probes both completed `32768` steps and wrote final
models.
