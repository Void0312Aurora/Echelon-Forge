...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `TG-P0` | main thread | n/a | Create subproject entry, status, and dispatch queue. | `docs/systems/effects/reviews/f16c_target_geometry_20260614/**`; parent A2 README; issue pointer | No tool implementation; no runtime change | markdown links, `git diff --check` | Docs are navigable from parent and issue | none | 1 | pass |
