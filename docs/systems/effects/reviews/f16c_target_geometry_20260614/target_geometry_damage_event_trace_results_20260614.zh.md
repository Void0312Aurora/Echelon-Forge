...
```bash
PYTHONPATH=build-workshop:. python tools/geometry/target_geometry_damage_event_trace.py --output docs/systems/effects/reviews/f16c_target_geometry_20260614/review_packets/f16c_20260611/target_geometry_damage_event_trace_20260614.json
