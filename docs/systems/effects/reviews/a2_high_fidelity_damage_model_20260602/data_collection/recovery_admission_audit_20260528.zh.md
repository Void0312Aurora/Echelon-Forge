...
状态：`recovered / admission-audit / non-authoritative`。本文档审计 A2 高保真空战毁伤模型的公开来源收集包是否遵守 [公开数据来源准入标准](../../../../../research/standards/public_data_source_admission.zh.md) 与 [A2 数据来源准入规则](source_admission_rules_20260528.zh.md)。它不创建 runtime descriptor，不授予 Pk、deterministic fuze、effect-scale 或 component-failure probability authority。
...
5. 所有后续运行时接入必须回到 [公开数据来源准入标准](../../../../../research/standards/public_data_source_admission.zh.md) 的 authority gate 规则。
