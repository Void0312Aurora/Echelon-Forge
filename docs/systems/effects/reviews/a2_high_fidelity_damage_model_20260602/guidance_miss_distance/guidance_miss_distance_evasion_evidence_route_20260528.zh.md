...
```bash
rg -n "proximity_min_dist_m|fuze_hit_probability|resolved_compatibility_damage_evasion|miss_distance_m|vulnerability_miss_distance_scale" src tests docs/systems/effects/reviews/a2_high_fidelity_damage_model_20260602 -S
