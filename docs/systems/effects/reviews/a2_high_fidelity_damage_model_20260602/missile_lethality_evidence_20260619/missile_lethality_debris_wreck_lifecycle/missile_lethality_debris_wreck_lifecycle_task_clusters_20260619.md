...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `MLF-8-P0` | main thread | n/a | Create subproject entry, status, contract surface, dispatch queue, archive placeholder, and parent navigation. | `docs/systems/effects/reviews/a2_high_fidelity_damage_model_20260602/missile_lethality_evidence_20260619/missile_lethality_debris_wreck_lifecycle/**`; parent A2 and air-combat README files | Runtime edits, tests, reward changes | Markdown links, `git diff --check` | Subproject is navigable and scope-limited | first, serial | 1 | complete / link-pass |
