...
| --- | --- | --- | --- |
| `2026-06-19` | `MLF9-Q0` | pass | Subproject docs and parent A2 links created; `git diff --check -- docs/systems/effects/reviews/a2_high_fidelity_damage_model_20260602` passed; local Markdown link inspection over 12 files found 0 missing links. |
