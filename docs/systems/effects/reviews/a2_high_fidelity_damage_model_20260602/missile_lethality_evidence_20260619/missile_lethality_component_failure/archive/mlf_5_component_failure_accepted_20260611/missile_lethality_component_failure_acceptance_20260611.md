...
- `test_component_damage_event_surface.py`: standard component damage event surface, sample-trigger gate, before/after integrity, and Python binding.
...
- `test_warhead_spatial_component_projection.py`: upstream warhead/spatial/component load fact projection.
...
- `test_diagnostics_probe_contracts.py`: diagnostics schema v2, `component_damage` stage, standard-event priority, and untriggered-sample guard.
