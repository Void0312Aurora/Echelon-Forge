...
[damage_model.py](../../../../../../../tools/maintenance/damage_model.py) `release-governance scoped-release-identity`。
...
```bash
python3 tools/maintenance/damage_model.py release-governance scoped-release-identity
