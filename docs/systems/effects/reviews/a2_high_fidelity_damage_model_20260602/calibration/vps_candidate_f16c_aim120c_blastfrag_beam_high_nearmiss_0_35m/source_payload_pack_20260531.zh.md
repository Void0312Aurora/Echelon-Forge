...
[damage_model.py](../../../../../../../tools/maintenance/damage_model.py) `source-governance payload-pack`。
...
```bash
python tools/maintenance/damage_model.py source-governance payload-pack --write-retained-artifacts
