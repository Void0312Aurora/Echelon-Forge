...
[damage_model.py](../../../../../../../tools/maintenance/damage_model.py) `candidate-artifacts component-fragility-review-gate`。
...
```bash
python tools/maintenance/damage_model.py candidate-artifacts component-fragility-review-gate --output /tmp/a2_stage_c_fragility_review_gate.json
