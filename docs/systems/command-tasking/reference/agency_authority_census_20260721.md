...
Canonical: `docs/systems/command-tasking/reference/agency_authority_census_20260721.md`
Owner: `systems/command-tasking/agency-authority`
Last verified: `2026-08-08`
Verification boundary: owner route, lifecycle, maintained ratchet route, and
held semantic boundary were rechecked; the detailed census remains pinned to
its recorded source baseline.
