...
| 4 | `P2-A Native Lifecycle Kernel` | pass | P1-A/P1-B gate 已通过 | 隔离原生 composition library、聚焦 C++ test、architecture guard 与 CMake wiring | 普通 MSVC 与 ASan build 均为 8 tests/149 assertions；lifecycle、rollback、rebuild、invalidation 与 deterministic validation 证据 |
