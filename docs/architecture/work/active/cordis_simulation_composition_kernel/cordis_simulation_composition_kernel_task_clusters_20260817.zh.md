...
状态：`2026-08-20`，[Cordis 仿真组合内核](README.zh.md)的有限交付计划；P0、P1-A 与
P1-B 已通过，P2-A 已作为原生 lifecycle baseline 通过，P2-B 已实现并等待独立审阅与残余证据。
