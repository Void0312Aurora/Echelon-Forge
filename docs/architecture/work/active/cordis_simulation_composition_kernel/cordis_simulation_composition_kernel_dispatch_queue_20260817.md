...
| 4 | `P2-A Native Lifecycle Kernel` | pass / independently repaired | P1-A/P1-B gates passed | isolated native composition library, focused C++ test, architecture guard, and CMake/CI wiring | 14 tests/381 assertions in normal MSVC and ASan builds; hash, typed-scope, lifecycle-state, rollback, serialized replacement rebuild, reentrant lifetime, plugin/factory identity, stable service ABI, handover, invalidation, and deterministic validation evidence |
