...
- It is subordinate planning input to the strict simulation architecture
  standard, not architecture authority or a frozen task sheet.
- Concrete implementation work should be derived into contract docs or separately frozen execution plans.

This retained draft describes a candidate path from module cleanup toward
