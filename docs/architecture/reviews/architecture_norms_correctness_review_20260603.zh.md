...
Canonical: `docs/architecture/reviews/architecture_norms_correctness_review_20260603.zh.md`
Owner: `architecture/reviews`
Last verified: `2026-06-03`
Review basis: `2026-06-03`
Authority: 保留的评审快照，不代表当前架构或实现事实。
Migration note: 所有权与路径于 `2026-08-07` 变更；迁移期间未重新核验事实性陈述。
...
在 `docs/architecture/reference/` 下建立矩阵：
