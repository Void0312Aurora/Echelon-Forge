...
> 当前标准化建模基线请改看 [docs/standards/README.md](/home/void0312/CMO/docs/standards/README.md)。
...
- [Task Order & Leader Layer Standard](../standards/air/com/task_order_leader_standard.md)
- [CAP 任务与长机层落地计划](../standards/air/com/cap_task_bootstrap_plan.md)
...
- 场景与任务编排：`gym_envs/scenario_loader.py`
- 长机层训练环境：`gym_envs/leader_env.py`
- 通用执行层训练环境：`gym_envs/universal_env.py`
- 长机规则与任务桥接：`python/rl/leader_tasking.py`
...
1. [C2 层](./layers/c2_layer.md)
2. [长机层](./layers/leader_layer.md)
3. [执行层](./layers/execution_layer.md)
4. [操作层与物理层](./layers/operation_physics_layer.md)
5. [内核绑定、测试与可视化](./layers/kernel_binding_test_layer.md)
6. [接口修改热点](./interface_hotspots.md)
...
- [`src/components/systems/comm.h`](/home/void0312/CMO/src/components/systems/comm.h)
