...
| 3 | `docs/standards/` | Owns naming, layering, service/domain ownership, public-source admission, bilingual policy, and governance rules. |
...
| What realism claims are allowed? | [Gradient Realism Principles](../../standards/foundation/gradient_realism_principles.md), [Public Data Source Admission Standard](../../standards/foundation/public_data_source_admission.md), [Realism Authority Boundary](../../standards/foundation/realism_authority_boundary.zh.md) |
...
| --- | --- |
| Documentation refresh | Root README, docs index, this map, affected local README, standards owner. |
