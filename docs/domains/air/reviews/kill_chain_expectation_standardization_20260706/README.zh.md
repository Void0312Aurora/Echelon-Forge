...
Review basis：保留的 P0-P5 文档与 `2026-07-06` 只读 envelope audit。

状态：保留 review 包；`2026-07-06` 已接受有边界的
expectation-standardization 证据 +
...
- 修正机制连续包络重建：
  [第四阶段结论](../../../../systems/weapons/reviews/kill_chain_guidance_mechanism_20260715/review_packets/kill_chain_guidance_envelope_rebuild_20260715/kill_chain_guidance_envelope_rebuild_20260715_conclusions.zh.md)
- 受约束制导标量校准：
  [第五阶段结论](../../../../systems/weapons/reviews/kill_chain_guidance_mechanism_20260715/review_packets/kill_chain_guidance_scalar_calibration_20260715/kill_chain_guidance_scalar_calibration_20260715_conclusions.zh.md)
- 第四/第五阶段校准热图证据：
  [热图与图示结论](../../../../systems/weapons/reviews/kill_chain_guidance_mechanism_20260715/review_packets/kill_chain_guidance_calibration_visualization_20260715/kill_chain_guidance_calibration_visualization_summary_20260715.md)
...
- P5 后已启动 initial harness implementation：`tools/diagnostics/kill_chain_expectation_harness.py`
  ...
  随后的 `2026-07-15`
  [制导机制消融](../../../../systems/weapons/reviews/kill_chain_guidance_mechanism_20260715/review_packets/kill_chain_guidance_mechanism_ablation_20260715/kill_chain_guidance_mechanism_ablation_conclusions_20260715.zh.md)
...
- 随后的五阶段制导机制工作已按顺序完成：世界系 LOS-history PN 和世界系 CV tracker
  ...
  因而未修改 AIM-120 JSON。完整 `93` anchor-grid 中的 `15` 个 mild-maneuver cases、
  并行 worker 和机动目标 runtime 支持仍未完成。
