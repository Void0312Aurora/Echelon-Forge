...
语言：[英文主文](naval_progress_snapshot_20260527.md)；中文配套。

Document kind: `review`
Lifecycle: `maintained`
Canonical: `docs/domains/naval/reviews/naval_progress_snapshot_20260527.md`
Owner: `domains/naval/reviews`
Last verified: `2026-08-08`
Review basis：`2026-05-27` 工作区抽样；后续当前权威归 Naval owner README 与 active work package。

状态：保留的 `2026-05-27` 工作区抽样复核，纳入 N4 bridge 验收与 N4 RL
action/observation surface 修复。

本文档是 `2026-05-17` 海军进度检查点之后的带日期证据快照，
不再是 active tracking 入口。当前状态和 residuals 应从 Naval owner README
与 domain-surface split 工作包读取。本快照重点记录三件事：
...
- 舰船平台与运动：
  - [ship_platform.h](../../../../src/components/domains/naval/platform/ship_platform.h)
  - [ship_motion_system.h](../../../../src/systems/domains/naval/ship_motion_system.h)
- 潜艇平台与运动：
  - [submarine_platform.h](../../../../src/components/domains/naval/platform/submarine_platform.h)
  - [submarine_motion_system.h](../../../../src/systems/domains/naval/submarine_motion_system.h)
- 舰载机 token 协同：
  - [embarked_air_ops.h](../../../../src/components/domains/naval/platform/embarked_air_ops.h)
  - [embarked_air_ops_system.h](../../../../src/systems/domains/naval/embarked_air_ops_system.h)
- 海军命令扩展：
  - [mission_command_naval.h](../../../../src/components/domains/naval/command/mission_command_naval.h)
  - [task_order_naval.h](../../../../src/components/domains/naval/tasking/task_order_naval.h)
- 舰载武器：
  - [naval_weapon_mounts.h](../../../../src/models/weapons/naval_weapon_mounts.h)
  - [naval_mission_weapon_release_system.h](../../../../src/systems/domains/naval/naval_mission_weapon_release_system.h)
- 后勤和 UNREP：
...
[naval_n4_rl_task_surface_preflight_20260525.zh.md](../../../task/naval/archive/n4_threat_roe_bridge/naval_n4_rl_task_surface_preflight_20260525.zh.md)。
已接受的下一步 RL 兼容任务候选是：
...
- [N4 RL 任务面预检](../../../task/naval/archive/n4_threat_roe_bridge/naval_n4_rl_task_surface_preflight_20260525.zh.md)
- [N4 集成验收](../../../task/naval/archive/n4_threat_roe_bridge/naval_n4_integration_acceptance_20260525.zh.md)
- [N4 闭合](../../../task/naval/archive/n4_threat_roe_bridge/naval_n4_closure_20260525.zh.md)
