...
Status: `2026-05-10` Interface contract draft.  
...
This document defines the `runtime facade` contract direction under maintenance, used to isolate the frontend from the underlying
