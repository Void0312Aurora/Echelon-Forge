...
- [x] `WP6` New `tests/architecture/test_runtime_facade_layering.py` has been added as a dependency direction regression check.
...
- New `tests/architecture/test_runtime_facade_layering.py`
- Or merge into [tests/runtime/test_runtime_facade.py](../../../tests/runtime/test_runtime_facade.py)
