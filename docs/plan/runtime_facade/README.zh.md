...
<!-- 机器翻译草稿，生成于2026-05-18，源自 docs/plan/runtime_facade/README.zh.md。在将此文件视为权威之前，请审阅。 -->

<!-- 机器翻译草稿，生成于2026-05-18，源自 docs/plan/runtime_facade/README.md。在将此文件视为权威之前，请审阅。 -->

# `runtime_facade/`

此目录包含运行时门面主线的契约、执行记录和后续清理计划。
...
- `task_bootstrap` 现在包含第一批 `WP1-WP6` 的执行记录。
