...
| [exact_runtime/cuda_resident_runtime_program_2_20260731.zh.md](exact_runtime/cuda_resident_runtime_program_2_20260731.zh.md) | CR2-0 candidate freeze | 新的显式 continuation program；强制规模治理，CR2-1 必须先拆分 2528 行 CUDA device module，晋级继续受 gate 约束 |
