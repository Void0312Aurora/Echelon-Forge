...
| 文档 | 当前状态 | 说明 |
|------|-----------|------|
| [exact_runtime/cuda_resident_backend_program_20260729.zh.md](exact_runtime/cuda_resident_backend_program_20260729.zh.md) | 独立后端计划无晋级关闭 | 独立 CUDA 驻留后端的单一执行权威；分支内 candidate 保留作研究，未来工作必须建立新计划 |
| [exact_runtime/cuda_resident_runtime_program_2_20260731.zh.md](exact_runtime/cuda_resident_runtime_program_2_20260731.zh.md) | 后续运行时计划无晋级关闭 | 保留第二后端实现与证据；achieved-counter gate、显式 promotion/integration 授权仍缺失，未来工作需建立新计划 |
