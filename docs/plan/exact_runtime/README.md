...
4. [cpp_exact_runtime_refactor_plan.md](cpp_exact_runtime_refactor_plan.md)
5. [gpu_execution_mainline_integration_checklist.md](gpu_execution_mainline_integration_checklist.md)
6. [gpu_execution_phase4_rollout_hot_path_freeze.md](gpu_execution_phase4_rollout_hot_path_freeze.md)
7. [../archive/exact_runtime/README.md](../archive/exact_runtime/README.md)
...
- The CUDA-resident second-backend program is the single frozen execution plan
  ...
  evidence and the sole next authorization; the RB10 hold decision records the
  current no-promotion boundary. Later rows remain dependency-gated.
