...
1. **地面接触系统 (GroundContact)**
   ...
   - 实现内容:
     ...
     - 地面恢复力矩
     - 起落架应力/坍塌逻辑
   - 参考: [src/systems/physics/ground_contact_system.h](/home/void0312/Workshop/CMO/src/systems/physics/ground_contact_system.h)
...
2. **力计算系统 (ComputeForces)**
   ...
   - 实现内容:
     - 重力: `F = m * g`
     - 推力: 从推进系统获取
   - 参考: [src/systems/physics/force_system.h](/home/void0312/Workshop/CMO/src/systems/physics/force_system.h)
...
3. **完整气动力系统 (ComputeAerodynamics)**
   ...
   - 实现内容:
     ...
     - 控制面偏转效应
     - 失速后气动特性
   - 参考: [src/systems/physics/aerodynamics_system.h](/home/void0312/Workshop/CMO/src/systems/physics/aerodynamics_system.h)
...
4. **完整控制律系统 (FlightControl)**
   ...
   - 实现内容:
     ...
     - 配平逻辑
     - 飞行包线保护
   - 参考: [src/systems/physics/control_system.h](/home/void0312/Workshop/CMO/src/systems/physics/control_system.h)
...
5. **蛙跳积分器 (LeapfrogIntegrate)**
   ...
   - 实现内容:
     - 蛙跳积分器语义
     - 速度-位置交错更新
   - 参考: [src/systems/physics/leapfrog_system.h](/home/void0312/Workshop/CMO/src/systems/physics/leapfrog_system.h)
...
| A2: SoA 打包优化 | `src/core/engine/exact_stage_inventory.cpp` | 以当前 exact-stage 契约为基线重估打包与阶段边界 |
| A3: CUDA Graph 固化 | `src/gpu/experimental/README.md` | 仅在实验 GPU exact backend 重新冻结后进入实现 |
...
| 文件 | 说明 |
|------|------|
| [src/core/engine/exact_stage_inventory.cpp](/home/void0312/Workshop/CMO/src/core/engine/exact_stage_inventory.cpp) | 当前 exact-stage 契约与阶段说明入口 |
| [src/core/engine/simulation_kernel.cpp](/home/void0312/Workshop/CMO/src/core/engine/simulation_kernel.cpp) | CPU ECS 精确步进参考 |
| [src/systems/physics/ground_contact_system.h](/home/void0312/Workshop/CMO/src/systems/physics/ground_contact_system.h) | 地面接触系统参考 |
| [src/systems/physics/force_system.h](/home/void0312/Workshop/CMO/src/systems/physics/force_system.h) | 力系统参考 |
| [src/systems/physics/aerodynamics_system.h](/home/void0312/Workshop/CMO/src/systems/physics/aerodynamics_system.h) | 气动力系统参考 |
| [src/systems/physics/control_system.h](/home/void0312/Workshop/CMO/src/systems/physics/control_system.h) | 控制系统参考 |
| [src/systems/physics/leapfrog_system.h](/home/void0312/Workshop/CMO/src/systems/physics/leapfrog_system.h) | 蛙跳积分器参考 |
| [src/gpu/README.md](/home/void0312/Workshop/CMO/src/gpu/README.md) | 当前 GPU helper/runtime 主目录边界说明 |
| [src/gpu/experimental/README.md](/home/void0312/Workshop/CMO/src/gpu/experimental/README.md) | 实验 GPU backend/探针入口 |
| [docs/plan/archive/gpu_exact_world_step_migration_plan.md](/home/void0312/Workshop/CMO/docs/plan/archive/gpu_exact_world_step_migration_plan.md) | 原始迁移计划 |
