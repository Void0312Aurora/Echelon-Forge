...
文档类型：`reference`
生命周期：`maintained`
规范路径：`docs/plan/archive/unified_architecture_program_completed_20260727/t11_content_pipeline_census_20260721.md`
...
- [仿真系统架构设计](../../../architecture/standards/simulation_system_architecture_design.zh.md)（SCAL 语义图面；`P0 ContentCompile`；第 6.1 节阶段契约）
