...
文档类型：`plan`
生命周期：`maintained`
规范路径：`docs/plan/archive/unified_architecture_program_completed_20260727/README.md`
...
- 迭代台账保留在
  [仓库整合计划](../repository_consolidation_completed_20260729/README.zh.md)的登记表中。
...
（[计划](../../../architecture/work/issues/exact_runtime/cpp_exact_runtime_refactor_plan.zh.md)）与
