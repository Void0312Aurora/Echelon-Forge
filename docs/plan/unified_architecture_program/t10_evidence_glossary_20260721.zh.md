...
文档种类：`reference`
生命周期：`maintained`
正本：`docs/plan/unified_architecture_program/t10_evidence_glossary_20260721.md`
...
词汇以
[Simulation System Architecture Design](../architecture/simulation_system_architecture_design.zh.md)
...
- [Simulation System Architecture Design](../architecture/simulation_system_architecture_design.zh.md)（SCAL Evidence Graph 面）
