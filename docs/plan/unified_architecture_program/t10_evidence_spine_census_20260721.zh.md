...
文档种类：`reference`
生命周期：`maintained`
正本：`docs/plan/unified_architecture_program/t10_evidence_spine_census_20260721.md`
...
- [Simulation System Architecture Design](../architecture/simulation_system_architecture_design.md)（SCAL Evidence Graph 面）
