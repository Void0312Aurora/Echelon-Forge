...
Canonical: `docs/plan/unified_architecture_program/t9_authority_representation_adjudication_20260726.md`
Owner: `unified architecture program workline`
Last verified: `2026-07-26`
Baseline commit: `c10cceac`

Status: T9 (agency and doctrine architecture) adjudication slice for the
[Unified Architecture Program](README.md). The I68 A3 default-name ownership
