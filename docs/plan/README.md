...
| Document | Current Status | Notes |
|----------|----------------|-------|
| [exact_runtime/cuda_resident_backend_program_20260729.md](exact_runtime/cuda_resident_backend_program_20260729.md) | Independent-backend program closed without promotion | Single execution authority for an independent CUDA-resident backend; the branch-local candidate is retained for research and future work requires a new program |
| [exact_runtime/cuda_resident_runtime_program_2_20260731.md](exact_runtime/cuda_resident_runtime_program_2_20260731.md) | Follow-up runtime program closed without promotion | Second-backend implementation and evidence are retained; the achieved-counter gate and explicit promotion/integration authorization remain absent, so future work requires a new program |
