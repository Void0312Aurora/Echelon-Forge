...
| [exact_runtime/cuda_resident_runtime_program_2_20260731.md](exact_runtime/cuda_resident_runtime_program_2_20260731.md) | CR2-0 candidate freeze | New explicit continuation program; size governance is mandatory, CR2-1 must split the 2528-line CUDA device module before semantic growth, and promotion remains gated |
