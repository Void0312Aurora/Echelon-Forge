...
本保留 issue 用于追踪
[测试系统治理](../../../reviews/test_system_governance_20260621/README.zh.md)
当前切片验收后仍必须可见的残余项。

负责线程：测试系统治理线和后续 runtime/test 负责人。

首次观察：`2026-06-21`，现保留为
[测试系统治理 review](../../../reviews/test_system_governance_20260621/README.zh.md)的收口期间。
