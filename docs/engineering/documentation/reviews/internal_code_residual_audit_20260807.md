...
- English canonical: `internal_code_residual_audit_20260807.md`
...
- Nine maintained entry-point documents form a complete-file, zero-finding
  blocking baseline.
...
- [Internal Code Naming Policy](../standards/internal_code_policy.md)
- [CUDA Resident Semantic Stage Migration](../../../architecture/work/issues/exact_runtime/cuda_resident_semantic_stage_migration_20260807.md)
