...
- 英文主文：`bilingual_documentation_policy.md`
...
- `docs/**/temp/`、`docs/temp/`、`docs/plan/archive/`、
  `docs/plan/results/` 下的临时稿、草稿和本地分析记录
...
- [document_alignment_map.md](document_alignment_map.md)
