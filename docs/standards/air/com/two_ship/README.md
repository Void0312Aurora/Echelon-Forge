...
> 当前标准化基线请改看 [docs/standards/README.md](/home/void0312/CMO/docs/standards/README.md) 及 `joint/service profile` 文档。
...
1. [战术层级标准](./tactical_hierarchy_standard.md)
2. [数据模型增量](./data_model_delta.md)
3. [RL 范围与课程计划](./rl_scope_and_curriculum.md)
4. [双机 MVP 与验收标准](./mvp_scope_and_acceptance_standard.md)
5. [双机实现切分标准](./implementation_cut_standard.md)
