...
```bash
git diff --check -- docs/learning/reviews/optimal_stopping_model_selection_20260605 docs/learning/README.md docs/learning/README.zh.md
rg -n "recommend|fallback|reject|censor|hazard|stopping" docs/learning/reviews/optimal_stopping_model_selection_20260605
```
