...
```bash
git diff --check -- docs/learning/reviews/optimal_stopping_model_selection_20260605 docs/task/model/archive/owner_migration_20260808/README.md docs/task/model/archive/owner_migration_20260808/README.zh.md
