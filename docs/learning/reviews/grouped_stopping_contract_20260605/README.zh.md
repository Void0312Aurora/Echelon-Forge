...
Canonical: `docs/learning/reviews/grouped_stopping_contract_20260605/README.md`
Owner: `learning/reviews`
Last verified: `2026-08-08`
Review basis：`2026-06-05` P0-P5 合同与训练证据；不声明 learned-policy acceptance。
...
- A7 当前经验堵塞：
  [A7 当前状态](../optimal_stopping_model_selection_20260605/a7_event_value_advantage_credit_head_20260604/a7_event_value_advantage_credit_head_current_status_20260604.zh.md)
- 子项目标准：
