...
语言：[英文主文](README.md)；中文详细记录。

Document kind: `task`
Lifecycle: `maintained`
Canonical: `docs/learning/work/active/temporal_window_hmoe/README.md`
Owner: `learning/policy-experiments`
...
- [时间 HMoE 策略计划](../../issues/temporal_policy_roadmap.md)
...
|----|------|------|--------|--------|------|----------|
| `M1-A0 文档与边界冻结` | accepted | 记录 M1 是路径 C 前的验证包，并冻结不新增战术记忆板原则。 | `docs/learning/work/active/temporal_window_hmoe/**` | 代码实现 | 文档 diff 检查 | README 与 cluster 明确 release gate |
...
| `M1-A5 路径 C release vote` | held | 在 A3-aware evidence 下判断是否进入 M2 实现。 | `docs/learning/work/active/temporal_window_hmoe/**` | 代码实现 | M1 + A3 结果复盘 | 接受、延迟或拒绝 M2 |
