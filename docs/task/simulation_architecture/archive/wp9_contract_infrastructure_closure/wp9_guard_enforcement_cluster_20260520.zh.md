...
```bash
git diff --check
pytest tests/architecture/runtime_facade/test_layering.py tests/architecture/test_wp5_design_boundary_gates.py tests/runtime/bindings/test_bindings_engagement_surface.py
