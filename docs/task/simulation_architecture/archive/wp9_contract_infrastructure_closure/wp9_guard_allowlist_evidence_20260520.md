...
| `diagnostics_only` | `python/testing/contracts/`, `examples/viz/runtime/`, `tools/diagnostics/`, `tools/eval/`, `tools/maintenance/damage_model.py candidate-artifacts runtime-authority-exercise`, and `world_model_train.py` |
| `test_only` | `tests/` |
