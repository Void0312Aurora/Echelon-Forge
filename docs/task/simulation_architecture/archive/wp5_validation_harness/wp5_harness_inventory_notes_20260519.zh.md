...
|--------------|---------------|------|
| `tests/architecture/runtime_facade` | design/boundary 主证据，覆盖 facade layering 与 raw-runtime escape hatch containment。 | 保留，是 WP5-B 最强 immediate anchor。 |
