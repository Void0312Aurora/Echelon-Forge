...
|--------------|-------------------|----------------|
| `tests/architecture/runtime_facade` | Primary design and boundary evidence for facade layering and raw-runtime escape-hatch containment. | Keep. This is the strongest immediate WP5-B smoke anchor. |
