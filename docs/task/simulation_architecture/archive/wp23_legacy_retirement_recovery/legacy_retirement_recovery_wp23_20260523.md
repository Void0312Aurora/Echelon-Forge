...
- Existing tests document coexistence rather than retirement:
  ...
  `tests/architecture/runtime_facade/test_runtime_facade_contract_boundaries.py` explicitly
...
- Current architecture guards localize, but do not remove, escape-hatch
  consumers: `tests/architecture/runtime_facade/test_scenario_setup_facade_boundary.py`
...
- Existing guards already localize the most important escape hatches:
  `tests/architecture/runtime_facade/test_scenario_setup_facade_boundary.py` covers
