...
- [system layering and engine encapsulation plan](../../../../architecture/work/issues/system_layering_and_engine_encapsulation_plan.md)
- [architecture and performance follow-up](../../../../architecture/work/issues/architecture_and_performance_research_followup.md)
...
14. Post-WP9 work should follow the post-WP9 architecture route plan
    (`git show b72731a8~1:docs/task/simulation_architecture/archive/post_wp9_architecture_route_plan_20260520.md`):
...
18. The post-WP21
    [architecture refactoring audit](../../../../architecture/reviews/architecture_refactoring_audit_20260522.md)
...
history, but their task packets live under [archive/](../README.md) rather
