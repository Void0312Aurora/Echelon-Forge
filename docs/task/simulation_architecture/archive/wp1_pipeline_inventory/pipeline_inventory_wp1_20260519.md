...
|-----------------|----------|-------|
| Facade layering | [test_runtime_facade_layering.py](../../../tests/architecture/runtime_facade/test_scenario_setup_facade_boundary.py) | Blocks raw runtime escape outside adapters and checks contract header hygiene. |
