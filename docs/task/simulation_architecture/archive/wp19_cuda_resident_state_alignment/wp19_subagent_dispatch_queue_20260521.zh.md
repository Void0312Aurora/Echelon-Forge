...
- `git diff --check` 通过。
- `python -m py_compile tests/architecture/runtime_facade tests/test_gpu_runtime_bindings.py tests/architecture/runtime_facade/test_runtime_dto_contracts.py` 通过。
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/architecture/runtime_facade` 通过：`22 passed`。
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/test_gpu_runtime_bindings.py` 通过：`12 passed`。
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/architecture/runtime_facade/test_runtime_dto_contracts.py -k "device_resident or packet"` 通过：`2 passed, 4 deselected`。
...
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/architecture/runtime_facade/test_runtime_dto_contracts.py -k "device_resident or packet"` 通过：`3 passed, 4 deselected`。
