...
- `python -m py_compile tests/architecture/runtime_facade tests/test_gpu_runtime_bindings.py tests/architecture/runtime_facade/test_runtime_dto_contracts.py` passed.
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/architecture/runtime_facade` passed: `22 passed`.
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/test_gpu_runtime_bindings.py` passed: `12 passed`.
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/architecture/runtime_facade/test_runtime_dto_contracts.py -k "device_resident or packet"` passed: `2 passed, 4 deselected`.
...
- `bash tools/maintenance/cmo_env.sh python -m pytest -q tests/architecture/runtime_facade/test_runtime_dto_contracts.py -k "device_resident or packet"` passed: `3 passed, 4 deselected`.
