...
| `WP7-B4 Layering Guard` | Ensure facade/core does not call or link GPU helper/probe implementation for capability projection. | `tests/architecture/test_runtime_facade_layering.py`. | Medium-high. |
