...
状态：`2026-06-01`，`P1-A/P1-B` 已验收；第二波已分发 `P2-A` 给 `Locke`，
`P3-B` 给 `Linnaeus`。`P2-B/P3-A/P4-A/P5-A` 继续 held。
...
| `DS-P2-A-action-transport` | `P2-A` | dispatched to `Locke` | action/runtime contracts and adapters | 若触及则 C++/binding，加 world-batch naval tests |
