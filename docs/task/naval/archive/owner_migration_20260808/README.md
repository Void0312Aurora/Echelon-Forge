...
- The latest state summary is
  [naval_current_progress_20260524.md](../../../../domains/naval/reviews/naval_progress_snapshot_20260527.md).
- The N4 threat/ROE bridge is closed as a pre-fire scenario and active
  ...
  [archive/n4_threat_roe_bridge/](../n4_threat_roe_bridge/README.md):
...
- The RL action/observation-surface split is implemented and retained as an
  ...
  [archive/n5_rl_action_surface_split/](../n5_rl_action_surface_split/README.md):
  [naval_n5_rl_action_surface_split_cluster_20260526.md](../n5_rl_action_surface_split/naval_n5_rl_action_surface_split_cluster_20260526.md).
...
- The current domain-surface split is tracked in
  [naval_domain_surface_split/README.md](../../../../domains/naval/work/active/naval_domain_surface_split/README.md).
...
- Closed N4 scenario-expansion subproject:
  [archive/n4_threat_roe_bridge/README.md](../n4_threat_roe_bridge/README.md)
- N4 closure record:
  [archive/n4_threat_roe_bridge/naval_n4_closure_20260525.md](../n4_threat_roe_bridge/naval_n4_closure_20260525.md)
- Implemented N4 RL action/observation repair, despite the `N5` directory name:
  [archive/n5_rl_action_surface_split/README.md](../n5_rl_action_surface_split/README.md)
  and
  [archive/n5_rl_action_surface_split/README.md](../n5_rl_action_surface_split/README.md)
