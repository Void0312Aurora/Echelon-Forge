...
| --- | --- | --- | --- |
| Unified viz entry | active foundation, first usable closure already recorded | [viz_unified_entry_session_profile_plan_20260516.md](../viz_unified_entry_session_profile_plan_20260516.md) | This does not solve the tactical-map layout or multi-map workspace. |
...
Post-closeout archive note: after this subproject closed, the full package was
moved under the parent viz archive at
[../tactical_map_interface_refactor/](../tactical_map_interface_refactor/README.md).
The nested [archive/README.md](archive/README.md) remains reserved for
superseded records inside this archived package.
