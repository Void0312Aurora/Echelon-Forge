...
- [air_combat/](../../air_combat/archive/owner_migration_20260808/README.md): `active` air/execution entry and the
...
- [common_air_naval/](../common_air_naval/common_air_naval_modular_split_plan_20260515.md): `archived` —
  ...
  analysis in archive.
- [simulation_architecture/](../../simulation_architecture/archive/phase3c_closeout_20260808/README.md): `active`
...
- [naval/](../../naval/archive/owner_migration_20260808/README.md): `active` medium-high maturity naval workline. N4 is
  ...
  reopen N4.
- [performance_runtime/](../performance_runtime/README.md): `archived` —
...
- [ground/](../../ground/archive/owner_migration_20260808/README.md): `planning` / early `active` ground tasking and
...
- [model/](../../model/archive/owner_migration_20260808/README.md): `planning` policy/world-model surface for temporal
...
- [viz/](../../viz/archive/owner_migration_20260808/README.md): `exploratory` / `active` visualization unified-entry
...
- [review/](../../review/archive/phase3c_closeout_20260808/README.md): `governance` review and acceptance-record
...
- [issues/](../../issues/archive/owner_migration_20260808/README.md): `governance` cross-cutting issue board for
...
- [flight_dynamics/](../../flight_dynamics/archive/phase3c_closeout_20260808/README.md): `archived` / reference realism
...
- [game/](../game/README.md): `archived` game frontend integration exploration.
