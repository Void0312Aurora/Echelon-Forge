...
- Completed tail-end organization for this round:
  ...
  - `tools/diagnostics/sanity_check.py` has been consolidated into the formal runtime test [tests/runtime/core/test_kernel_observation_sanity.py](../../../../tests/runtime/core/test_kernel_observation_sanity.py)
