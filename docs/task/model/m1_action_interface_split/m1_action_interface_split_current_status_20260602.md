...
2. Add weapon-employment shaping/curriculum or longer training so learned policy
   produces intentional pulses.
3. Once learned release appears, compare reactive/hybrid-temporal repeated
   release intervals.
