...
| 后续计划 | active | [M3-S1 Censored Optimal-Stopping Timing Contract](../m3_s1_censored_optimal_stopping_timing_contract/README.zh.md) 记录 architecture boundary map 与第一批实现切入点。 | data/censoring 与 grouped-objective contracts 存在前，代码仍 held。 |
