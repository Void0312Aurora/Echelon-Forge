...
- A7 execution breakpoint:
  [A7 Execution Breakpoint Analysis](../../air_combat/a7_event_value_advantage_credit_head/a7_event_value_advantage_credit_head_execution_breakpoint_analysis_20260605.md)
- A7 event-policy margin repair:
  [A7 Event-Policy Margin Repair](../../air_combat/a7_event_value_advantage_credit_head/a7_event_value_advantage_credit_head_event_policy_margin_repair_20260605.md)
- Subproject standard:
...
| Follow-on planning | active | [M3-S1 Censored Optimal-Stopping Timing Contract](../m3_s1_censored_optimal_stopping_timing_contract/README.md) records the architecture boundary map and first implementation cut points. | Code remains held until data/censoring and grouped-objective contracts exist. |
