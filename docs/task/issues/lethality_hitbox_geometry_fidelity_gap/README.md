...
[A2 Target Outer-Shape And Component Geometry](../../air_combat/a2_high_fidelity_damage_model/missile_lethality_target_geometry/README.md).
...
The `2026-06-11` first pass found no source, author, license, or Sketchfab UID embedded in the repository F-16 GLB; [Temp/Model/resource.md](../../../../Temp/Model/resource.md) also does not record an F-16 source.
