...
- [A6 发射窗口标签密度失衡](../../../../learning/work/issues/launch_window_label_imbalance/README.zh.md)：
...
- [HMoE 层级化计算断裂](../../../../learning/work/issues/hmoe_hierarchical_computation_gap/README.zh.md)：
...
- [Damage 到操控权限的传递缺口](../../../../systems/effects/work/issues/damage_control_authority_coupling_gap/README.zh.md)：
  damage report 可以记录飞行员/乘员、飞控、指挥/导航或通信/数据链失效，但后续控制输入、
  指挥链投递或数据链行为未必被禁用。该问题先暂存为后续跟踪项，不进入当前 fire-window sweep
  核心工作。
- [RL 策略保持基线漂移](../../../../learning/work/issues/policy_hold_baseline_drift/README.zh.md)：
