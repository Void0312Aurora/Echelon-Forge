...
Status: `2026-06-21` active retained issue for test-system residuals that
must remain visible after the scoped
[test-system governance](../../review/test_system_governance/README.md)
slice is accepted.

Owner thread: test-system governance and downstream runtime/test owners.

First observed: `2026-06-21`, during the closeout pass for
