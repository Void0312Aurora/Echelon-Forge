...
- 公开射击行、具体部件故障记录、调参发动机动力消费方和一段翼面/操纵气动消费方已经整合。
- 剩余近期切口应补充尾部、燃油/火灾和传感器/数据链下游响应证据，仍不得增加直接坠毁或“还能不能飞”捷径。
