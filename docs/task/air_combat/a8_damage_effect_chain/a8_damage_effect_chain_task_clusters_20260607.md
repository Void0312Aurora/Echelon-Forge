...
- Public shot rows, concrete part-failure records, and the tuned-engine
  propulsion consumer are integrated.
- The remaining near-term runtime cut is one wing/control aerodynamic or
  axis-authority response, still without a direct crash or can-fly shortcut.
