...
| `A8-DEC-G Acceptance And Index Sync` | main thread | n/a | Decide accepted or held, sync parent README/status, and record residuals. | A8 README/status/acceptance, parent air-combat README, archive index if needed | Marking docs-only work as runtime pass | docs link check plus accepted validation commands | Capability statement is evidence-backed and overclaims remain refused. | last, after H or explicitly held | 1 | partial pass: eighth wave W17/W18 accepted; P6 acceptance decision remains |
...
- Remaining near-term work is a P6 acceptance decision, not another direct
  crash or can-fly shortcut.
