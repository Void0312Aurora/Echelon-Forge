...
Observed before final rerun: compileall passed; focused HMoE/PPO tests passed
with `2 passed`; policy/update-strength tests passed with `7 passed`;
active-config tests passed with `2 passed`.
