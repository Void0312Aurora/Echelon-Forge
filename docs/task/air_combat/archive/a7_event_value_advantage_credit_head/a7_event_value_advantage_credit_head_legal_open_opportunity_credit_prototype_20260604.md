...
pytest tests/policy/test_first_event_timing_contracts.py::FirstEventTimingContractTests::test_legal_open_quality_credit_marks_no_release_quality_rows_before_deadline tests/policy/test_first_event_timing_contracts.py::FirstEventTimingContractTests::test_legal_open_quality_credit_requires_launch_window_evidence tests/policy/test_first_event_timing_contracts.py::FirstEventTimingContractTests::test_shadow_quality_repair_adds_post_early_positive_credit_without_reopening_fire_mask tests/policy/test_auxiliary_training_updates.py::AuxiliaryTrainingUpdateTests::test_nonfinite_probe_records_a7_projection_credit_stats tests/policy/test_auxiliary_training_updates.py::AuxiliaryTrainingUpdateTests::test_a7_legal_open_quality_credit_aligns_event_logits_without_projection -q
