...
- [空战 1v1 武器链回归测试](../../../../tests/runtime/air_combat/test_air_combat_1v1_fire_missile.py)
...
cmo_python -m pytest -q tests/runtime/air_combat/test_air_combat_1v1_fixture.py tests/runtime/air_combat/test_air_combat_1v1_fire_missile.py
```
