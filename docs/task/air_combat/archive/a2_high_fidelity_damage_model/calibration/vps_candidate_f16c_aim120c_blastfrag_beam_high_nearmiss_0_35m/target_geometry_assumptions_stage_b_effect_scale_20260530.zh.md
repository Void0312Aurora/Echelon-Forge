...
| `beam_witness_panel` | [damage_model_candidate_artifacts.py](../../../../../../tools/maintenance/damage_model_candidate_artifacts.py) `validation-scaffold`, `_bfm_bm_003()` witness length/height | `F16-TG-SRC-001/002/012` | `repo_authored_witness_geometry` | `side-on rectangular witness area = length * height` | `yes` | 真实 3D beam exposure、occlusion、局部曲面、局部 vulnerable area | `RES-003` |
