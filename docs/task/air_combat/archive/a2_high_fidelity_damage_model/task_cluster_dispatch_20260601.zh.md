...
- `tests/architecture/damage_model/test_external_benchmark_output_admission.py`
...
- `tests/architecture/damage_model/test_benchmark_recalculation_admission_chain.py`
