...
准入边界：遵守 [公开数据来源准入标准](../../../../../standards/foundation/public_data_source_admission.zh.md) 和 [A2 数据来源准入规则](../source_admission_rules_20260528.zh.md)。本文不授予 runtime authority，不创建 row，不校准 Pk、deterministic fuze、组件失效概率、材料厚度或 F-16 内部系统布局。
