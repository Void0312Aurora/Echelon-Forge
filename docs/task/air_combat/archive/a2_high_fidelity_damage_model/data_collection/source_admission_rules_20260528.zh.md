...
状态：`A2 specialization / non-authoritative`。本文档把仓库 foundation 层 [公开数据来源准入标准](../../../../standards/foundation/public_data_source_admission.zh.md) 映射到 A2 高保真空战杀伤模型。它只定义收集和准入规则，不授予任何运行时 authority。
...
- [Public Data Source Admission Standard](../../../../standards/foundation/public_data_source_admission.md)
