...
Status: `2026-06-04` archived accepted evidence packet. Bounded C2/ROE
implementation, P4 evidence, learned-policy probe, and post-launch observation
fix are recorded; M2 remains held. This subproject defines the air-combat C2,
