...
| `A6-EVT-J Event-Head Update-Strength Audit` | pass；held outcome | main thread 审计 A6 loss/optimizer routing，并新增 focused update-strength diagnostic test。 | `tests/policy/test_event_head_update_contracts.py`、A6 evidence note。 | 仅为 diagnostic；A6 与 M2 均继续 held。 |
