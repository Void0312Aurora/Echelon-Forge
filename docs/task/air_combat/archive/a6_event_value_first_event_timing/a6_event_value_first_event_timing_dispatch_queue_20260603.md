...
| `A6-EVT-J Event-Head Update-Strength Audit` | pass; held outcome | Main thread audited A6 loss/optimizer routing and added a focused update-strength diagnostic test. | `tests/policy/test_event_head_update_contracts.py`, A6 evidence note. | Diagnostic only; A6 still held and M2 still held. |
