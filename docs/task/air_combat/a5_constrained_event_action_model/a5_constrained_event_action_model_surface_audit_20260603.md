...
| Active configs/tests | `examples/config/training/active/air_combat/*c2_roe*_probe_v1.json`; tests under `tests/runtime`, `tests/hmoe`, `tests/training`, `tests/diagnostics` | First implementation should target active S1 C2/ROE shaped configs only. |
