...
| `a9_high_fidelity_weapon_system_accepted_with_residuals_20260616/` | 高保真武器系统。accepted_with_residuals：23 集群通过、5 项推迟、R2 EKF 定量验证仍开放，R4 马赫 Cd₀/k(M) 表已用工程代理值关闭。不声明 Pk、确定性引信、库存武器真值或武器特定权威。 |
