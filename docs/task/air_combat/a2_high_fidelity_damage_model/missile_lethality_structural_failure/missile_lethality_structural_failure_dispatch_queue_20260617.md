...
| `MLF-6F-W1` | `MLF-6F Diagnostics Export` | diagnostics worker | `tools/diagnostics/structural_breakup_export.py` | Python diagnostic export for `structural_breakup_events`. | planned |
