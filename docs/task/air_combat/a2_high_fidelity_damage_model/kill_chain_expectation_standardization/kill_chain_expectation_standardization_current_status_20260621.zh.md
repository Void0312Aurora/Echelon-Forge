...
- 已新增 `2026-07-15` 制导机制消融：
  [结论](../review_packets/kill_chain_guidance_mechanism_ablation_20260715/kill_chain_guidance_mechanism_ablation_conclusions_20260715.zh.md)。
...
| 标准化期望包络 v0 | pass | [docs/domains/air/work/issues/kill_chain_expectation_envelope.zh.md](../../../../domains/air/work/issues/kill_chain_expectation_envelope.zh.md) | 空中特化 planning supplement；不是当前 runtime contract，不修改 runtime 参数，也不授予 calibration authority。 |
