...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `KCES-P0 Project Boundary` | main thread | n/a | Create the subproject, status, queue, archive entry, and parent A2 links. | `docs/task/air_combat/a2_high_fidelity_damage_model/kill_chain_expectation_standardization/**`; parent A2 README files | Runtime/code/test changes; standards promotion | `git diff --check -- docs/task/air_combat/a2_high_fidelity_damage_model` | Required files exist, parent README links this project, and forbidden claims are explicit. | first, serial | 1 | pass |
