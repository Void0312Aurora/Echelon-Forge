...
- `docs/task/air_combat/a2_high_fidelity_damage_model/missile_lethality_component_failure/missile_lethality_component_failure_inventory_20260611.zh.md`
- `docs/task/air_combat/a2_high_fidelity_damage_model/missile_lethality_component_failure/missile_lethality_component_failure_inventory_20260611.md`

commands/outcomes:

- `git diff --check -- docs/task/air_combat/a2_high_fidelity_damage_model/missile_lethality_component_failure`: passed in the worker return and main-thread acceptance, no output.
- `rg -n "[[:blank:]]$" docs/task/air_combat/a2_high_fidelity_damage_model/missile_lethality_component_failure`: no matches in main-thread acceptance.
