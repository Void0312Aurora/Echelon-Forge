...
- 必须保留的既有证据：
  docs/task/air_combat/a2_high_fidelity_damage_model/archive/missile_lethality_structural_failure/README.zh.md
  docs/task/air_combat/archive/a8_damage_effect_chain/README.zh.md
...
```bash
git diff --check -- docs/task/air_combat/a2_high_fidelity_damage_model/archive/missile_lethality_secondary_consequence_coupling
```
