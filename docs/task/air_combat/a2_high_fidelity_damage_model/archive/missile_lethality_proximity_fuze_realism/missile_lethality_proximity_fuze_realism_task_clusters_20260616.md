...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `PF-P0` | main thread | n/a | Create the `docs/agent`-compliant planning surface and parent navigation. | `docs/task/air_combat/a2_high_fidelity_damage_model/missile_lethality_proximity_fuze_realism/**`; parent A2 README files | Runtime edits, tests, reward changes | Markdown inspection, local links, `git diff --check` | Subproject is navigable and states the current implementation boundary. | none | 1 | pass |
