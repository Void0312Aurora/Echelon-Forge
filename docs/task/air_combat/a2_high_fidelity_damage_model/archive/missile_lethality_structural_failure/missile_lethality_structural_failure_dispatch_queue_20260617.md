...
Status: `2026-06-18` v10 queue closed and archived. P1/P2, P3, P4, P5, P6 focused validation, P7 broad regression, and near-field continuous-rod / cumulative wing-loss calibration are complete. Archive movement is complete by explicit user instruction.
...
| `MLF-6I-C1` | `MLF-6I Acceptance And Archive` | main thread | docs/index and local archive registry | Summarize evidence, update status, sync parent READMEs, and register the archived package. | complete / archived |
...
- `MLF-6I-C1` is archived by explicit user instruction and now feeds MLF-7 as
  upstream evidence.
