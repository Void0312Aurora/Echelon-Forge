...
Status: `2026-06-18` accepted / archived v10 — P1/P2 corrected, P3 state
...
standoff/heatmap evidence. Archive movement is now complete by explicit user
instruction; this package is registered as local A2 archived evidence.
...
- **Converted inherited-baseline hold to acceptance-ready state.** The prior
  first-pass red state is superseded; no feature-only or inherited broad
  failures remain in the P7 lane.
- **Kept archive movement out of scope at that time.** The user requested P7
  closeout without archival; this hold is superseded by the 2026-06-18 explicit
  archive instruction.
...
| --- | --- | --- | --- |
| MLF-6 boundary (P0) | accepted / archived | [README.md](README.md) v2, D1-D7 frozen, [task clusters](missile_lethality_structural_failure_task_clusters_20260617.md), [dispatch queue](missile_lethality_structural_failure_dispatch_queue_20260617.md), [acceptance gate](missile_lethality_structural_failure_acceptance_20260617.md) | Scope remains frozen |
...
| MLF-6 regression (P7) | complete / archived | `PYTHONPATH=build-workshop:. pytest -q tests/runtime/air_combat/ tests/world_batch/` → `447 passed`; focused MLF-6 lanes green | Archived by explicit user instruction; MLF-7 consumes this as upstream fact evidence |
...
1. Treat MLF-6 as accepted / archived upstream evidence; the P7 broad lane is
   green.
2. Continue follow-on work in MLF-7 secondary consequence coupling rather than
   extending MLF-6.
3. Keep MLF-8/MLF-9/MLF-10 as separate future subprojects.
