...
| `GEB-TPC-GAP-002 open-source-license-pin` | C4DYNAMICS/BVRGym/JSBSim/FilterPy/Stone Soup/small PN repos | C4DYNAMICS MIT, BVRGym GPL-3.0, JSBSim LGPL-2.1 and FilterPy MIT were verified by shallow clone in this pass; Stone Soup MIT retained from existing ledger; one small PN repo has a license conflict and one repo has unknown license. | Record canonical license artifacts in future manifests, reconcile conflicts, exclude unknown-license repos. |
