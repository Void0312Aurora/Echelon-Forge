...
[a2_blastfrag_mechanism_source_closeout_gate.py](../../../../../../tools/maintenance/a2_blastfrag_mechanism_source_closeout_gate.py)，汇总 source ledger、artifact pin、target geometry assumption、warhead scope/sensitivity、Stage B/C author-side mechanism-load evidence。
...
| `tool_ref` | [a2_blastfrag_mechanism_source_closeout_gate.py](../../../../../../tools/maintenance/a2_blastfrag_mechanism_source_closeout_gate.py) |
