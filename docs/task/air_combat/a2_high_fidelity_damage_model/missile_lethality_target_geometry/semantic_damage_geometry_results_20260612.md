...
| Isolated semantic views | Added [semantic_damage_geometry_views/index.html](review_packets/f16c_20260611/semantic_damage_geometry_views/index.html) and manifest. Each semantic volume has its own top/side/front page with the volume proxy and linked receiver component boxes. | Review-only visual evidence; not a collision mesh. |
