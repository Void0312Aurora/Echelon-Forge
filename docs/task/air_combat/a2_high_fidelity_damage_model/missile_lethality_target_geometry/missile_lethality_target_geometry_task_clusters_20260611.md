...
Status: `2026-06-14` finite task-cluster plan with TG-P7-R5 damage-event trace
completed for [README.md](README.md).
...
- TG-P7 can advance into longer maintained training with a separate proxy
  ...
  targeted proxy damage-event traces.
...
- Main runtime-path replacement: TG-P7-R5 has an opt-in proxy database with a
  ...
  receivers; default runtime replacement is still pending longer proxy training
  and a later acceptance decision.
