...
- The database-level F-16 component example distinguishes wing fuel-cell and aileron-actuator consequences and exercises minimal critical/redundancy probability modulation.
...
Recent focused result for the component increment: `cmake --build build-workshop --target ef_py -j4` passed; the component-focused air-combat subset passed with `5 passed`; the engagement/binding contract subset passed with `27 passed`.
