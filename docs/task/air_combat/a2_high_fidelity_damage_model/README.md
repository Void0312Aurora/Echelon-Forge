...
Status: `2026-06-01 / active_index / non-authoritative`.

The maintained project entry is the Chinese index:
...
Current shorthand: A2 has a maintained structured-aircraft damage/effects runtime
surface and a non-authoritative blast-fragmentation candidate evidence package.
It does not yet grant stock runtime authority, Pk authority, or deterministic
fuze authority.
