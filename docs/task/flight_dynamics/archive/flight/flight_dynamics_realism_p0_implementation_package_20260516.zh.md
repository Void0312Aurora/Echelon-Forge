...
- [FlightDynamics 粗真实性守门测试](../../../../tests/runtime/air_combat/test_flight_dynamics_realism_guards.py)
...
在 [test_flight_dynamics_realism_guards.py](../../../../tests/runtime/air_combat/test_flight_dynamics_realism_guards.py) 上增加两类断言：
