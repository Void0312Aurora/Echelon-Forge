...
1. `tests/runtime/naval/test_naval_ship_database.py::NavalShipDatabaseTests::test_ddg_gun_can_fire_with_track_and_reduce_ammo`
2. `tests/runtime/naval/test_naval_ship_database.py::NavalShipDatabaseTests::test_naval_mission_command_can_trigger_ciws_without_direct_weapon_api`
3. `tests/runtime/mission/test_ship_mission_command_authority.py`
4. `tests/runtime/mission/test_naval_mission_command_mapping.py`
...
1. Existing `tests/runtime/air_combat/test_weapon_guidance_realism_guards.py`
2. Existing `tests/runtime/air_combat/test_air_combat_1v1_fire_missile.py`
