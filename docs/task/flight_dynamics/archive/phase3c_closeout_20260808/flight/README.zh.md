...
- [归档的飞行动力学真实化 P0 实施包](../../flight/flight_dynamics_realism_p0_implementation_package_20260516.zh.md)
  作用：已归档的最小气动/推进/失速骨架首轮实施范围。
- [归档的飞行动力学真实化 P1 实施包](../../flight/flight_dynamics_realism_p1_implementation_package_20260517.zh.md)
