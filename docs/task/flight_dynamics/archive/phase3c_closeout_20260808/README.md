...
multi-domain task tree. For active work, start from [../README.md](../../../archive/owner_migration_20260808/README.md)
...
- [task root](../../../archive/owner_migration_20260808/README.md):
  current multi-domain task-area navigation and lifecycle labels.
- [air_combat task track](../../../air_combat/archive/owner_migration_20260808/README.md):
  current combat and air-domain workline entry.
- [naval task track](../../../naval/archive/owner_migration_20260808/README.md):
  active naval domain task line.
- [ground task track](../../../ground/archive/owner_migration_20260808/README.md):
  early ground tasking/native-schema bootstrap line.
- [simulation_architecture task track](../../../simulation_architecture/archive/phase3c_closeout_20260808/README.md):
