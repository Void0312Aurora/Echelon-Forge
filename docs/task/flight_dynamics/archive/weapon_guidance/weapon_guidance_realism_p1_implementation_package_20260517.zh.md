...
4. 守门测试 [test_weapon_guidance_realism_guards.py](../../../../tests/runtime/air_combat/test_weapon_guidance_realism_guards.py) 当前通过。
5. 既有武器链回归 [test_air_combat_1v1_fire_missile.py](../../../../tests/runtime/air_combat/test_air_combat_1v1_fire_missile.py) 的关键命中用例已恢复通过。
