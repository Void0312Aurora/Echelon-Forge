...
- [Weapon chain regression test](../../../../tests/runtime/air_combat/test_air_combat_1v1_fire_missile.py)
...
6. `Add guard tests`
   - Add new [test_weapon_guidance_realism_guards.py](../../../../tests/runtime/air_combat/test_weapon_guidance_realism_guards.py)
