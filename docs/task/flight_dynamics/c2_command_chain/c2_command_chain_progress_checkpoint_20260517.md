...
Status: `2026-05-17` converged version after mainline continuous advancement.

Related documents:

- [Freeze analysis baseline](c2_command_chain_realism_analysis_20260517.zh.md)
...
- [Control authority test](../../../../tests/runtime/test_control_authority_arbitration.py)
...
- [Navy command mapping test](../../../../tests/runtime/test_naval_mission_command_mapping.py)
- [Ship authority test](../../../../tests/runtime/test_ship_mission_command_authority.py)
- [Mission state roundtrip test](../../../../tests/runtime/test_mission_command_naval_fields_roundtrip.py)
- [Air mission roundtrip test](../../../../tests/runtime/test_mission_command_air_fields_roundtrip.py)
...
- [ROE field test](../../../../tests/runtime/test_mission_command_roe_fields.py)
- [ROE runtime test](../../../../tests/runtime/test_weapon_roe_runtime.py)
...
- [CommandLink QoS test](../../../../tests/runtime/test_command_link_qos.py)
...
- [DataLink QoS runtime test](../../../../tests/runtime/test_data_link_qos_runtime.py)
...
- [Air combat 1v1 missile tests](../../../../tests/runtime/test_air_combat_1v1_fire_missile.py)
