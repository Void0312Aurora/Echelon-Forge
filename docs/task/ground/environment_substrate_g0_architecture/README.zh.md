...
状态：`2026-06-06` accepted and closed shared component-based environment
...
- Ground 父入口：[../README.zh.md](../README.zh.md)
- 当前 ground 进展：[../ground_current_progress_20260524.zh.md](../ground_current_progress_20260524.zh.md)
- 已接受 bootstrap 基线：
...
| --- | --- | --- | --- |
| Ground bootstrap | accepted | [accepted baseline](../archive/ground_domain_bootstrap_plan_20260521.zh.md) | 不释放 terrain-aware runtime behavior。 |
