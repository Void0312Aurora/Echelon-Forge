...
git diff --check -- .github/workflows/ci-smoke.yml CMakeLists.txt requirements docs/task/review/engineering_governance_p0 docs/task/review/archive/phase3c_closeout_20260808/README.md docs/task/review/archive/phase3c_closeout_20260808/README.zh.md
```
