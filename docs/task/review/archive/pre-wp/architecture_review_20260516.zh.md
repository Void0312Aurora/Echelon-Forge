...
- [tests/architecture/runtime_facade](../../../../tests/architecture/runtime_facade) 和 [test_cmake_target_readiness.py](../../../../tests/architecture/build/test_cmake_target_readiness.py) 将架构约束变成自动验证
