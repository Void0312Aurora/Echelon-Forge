...
```bash
CMO_BUILD_DIR=build-workshop pytest -q tests/architecture/test_wp12_intent_injection_authority_guard.py tests/architecture/test_wp12_agent_role_authority.py tests/architecture/test_wp12_information_transformation_surface.py tests/architecture/test_wp12_law14_read_side_enforcement.py tests/architecture/test_policy_belief_boundaries.py
