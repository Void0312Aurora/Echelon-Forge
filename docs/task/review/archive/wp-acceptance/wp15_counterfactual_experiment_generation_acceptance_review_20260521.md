...
| `WP15-D Scenario And Adversary Generation Request Surface` | pass | `tests/scenario/test_scenario_generation_contracts.py` passed, and `tests/scenario/test_scenario_compiler.py -k "wp15 or branch or runtime"` passed; the request surface stays additive and non-mutating. |
