...
- [Architecture Refactoring Audit — God Files, Legacy Code And Structural Inconsistency 2026-05-22](architecture_refactoring_audit_20260522.md) ([中文](architecture_refactoring_audit_20260522.zh.md))
...
- [Test System Governance](test_system_governance/README.md): accepted
  governance slice for auditing, simplifying, and tiering active non-archive
  pytest and JSON contract surfaces; remaining blockers are retained in
...
Completed architecture reviews (temp-01 response, temp-02 SCAL vision), WP9 consolidated roadmap, closed P1 governance remediation,
