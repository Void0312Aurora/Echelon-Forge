# [ARCHIVED] 旧 Air-First 标准文档说明

本目录保存旧的 `air-first` 标准化路线文档，原位置为 `docs/standards/air/com/`。

这些文档的特点是：

- 建立在“先空战、后泛化”的旧路线之上
- 仍可作为历史设计、字段演化和任务接口早期语境的参考
- 不再作为当前 `joint/common core + service profile + specialization` 标准树的主依据
