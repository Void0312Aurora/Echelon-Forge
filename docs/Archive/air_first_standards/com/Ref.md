...
本文档旨在梳理 `src/components` 下现有的 C++ 数据结构与新定义的 [飞行员标准](/home/void0312/Workshop/CMO/docs/standards/air/README.md) 之间的映射关系，并识别满足“拟真化”要求的改进点。
...
- [双机阶段标准总览](/home/void0312/Workshop/CMO/docs/Archive/air_first_standards/com/two_ship/README.md)
