...
|-------------|---------|
| [air_combat/](air_combat/) | Air combat damage model evaluation and improvement backlog |
| [weapons/](weapons/) | Weapons and engagement rules roadmaps, implementation notes, termination logic |
| [c2/](c2/) | C2 communication and command chain, operation layer and action space |
