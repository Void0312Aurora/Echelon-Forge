...
Lifecycle: `draft`
Canonical: `database/weapons/air_to_air/aim_120/aim_120c7/README.md`
...
Acts as the concrete data container for AIM-120C-7. It will hold identity, parameter, source, and future contract-mapping placeholders.
...
- Parent: `weapons/air_to_air/aim_120/`
- Children: None
