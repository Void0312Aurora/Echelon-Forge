...
- Family: NH90
- Variant: NFH (NATO Frigate Helicopter)
- Role: Naval multi-role helicopter for anti-submarine warfare, anti-surface warfare, maritime surveillance, search and rescue, vertical replenishment and casualty evacuation
- Manufacturer: NHIndustries, a consortium of Airbus Helicopters (62.5 percent), Leonardo (32 percent) and Fokker (5.5 percent)
- Configuration scope: the manufacturer publishes all NH90 technical data on a single platform page and gives the NFH its own maximum gross weight. The NFH-specific mission page carries no specification table.

## Operators

| Operator | Status | Source |
| --- | --- | --- |
| French Navy | In service | `p5-fr-air-nh90-nfh` |
...
| Auxiliary fuel tanks | 400 kg (882 lb) per internal tank; 492 kg (644 lb) per external tank | `p5-fr-air-nh90-nhindustries` | B |
| Cabin internal dimensions | Width 2.00 m (6.56 ft); length 4.80 m (15.75 ft); height 1.58 m (5.18 ft); volume 15.20 m³ (536.78 ft³) | `p5-fr-air-nh90-nhindustries` | B |
| Door and ramp openings | Sliding doors 1.60 × 1.50 m; rear ramp 1.78 × 1.58 m | `p5-fr-air-nh90-nhindustries` | B |
| Maximum cruise speed | 300 km/h (162 kt), reference condition below | `p5-fr-air-nh90-nhindustries` | B |
| Economical cruise speed | 260 km/h (140 kt), reference condition below | `p5-fr-air-nh90-nhindustries` | B |
| Maximum rate of climb | 11.2 m/s (2,200 ft/min), reference condition below | `p5-fr-air-nh90-nhindustries` | B |
| Rate of climb, one engine inoperative | 4.3 m/s (850 ft/min) at two-minute rating; 1.5 m/s (300 ft/min) continuous at 2,000 m (6,560 ft) | `p5-fr-air-nh90-nhindustries` | B |
...
The French Ministry of the Armed Forces page held for this leaf returns a site-under-maintenance response as of 2026-09-18 and contributes operator context only.
