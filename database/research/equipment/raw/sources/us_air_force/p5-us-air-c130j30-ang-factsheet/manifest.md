...
Estimation / uncertainty: Tier A official United States Air Force publication. The page carries conversion errors of its own, listed below; the metric values in the leaf are computed from the imperial figures.
...
| --- | --- | --- | --- |
| Length | 112 ft 9 in (source prints 34.37 m) | 97 ft 9 in (source prints 29.79 m) | 15 ft (source prints 4.58 m) longer fuselage |
| Wingspan | 132 ft 7 in (40.41 m) | 132 ft 7 in (40.41 m) | identical |
| Maximum take-off weight | 164,000 lb (source prints 74,389 kg) | 164,000 lb (source prints 74,389 kg) | identical structural limit |
| Maximum payload | 46,700 lb (source prints 21,183 kg) | 47,000 lb (source prints 21,319 kg) | the standard model is slightly higher |

## Conversion errors on this page

The page's own metric figures are wrong in several places and are corrected in the leaf rather than inherited.

112 ft 9 in is 34.69 m, not 34.37 m. 97 ft 9 in is 29.79 m, which is correct. The 15 ft stretch is 4.57 m, not 4.58 m. 164,000 lb is 74,389 kg, which is correct here but differs from the 74,393 kg the main Air Force fact sheet prints for the same weight. 46,700 lb is 21,183 kg, correct. 47,000 lb is 21,319 kg, correct.
