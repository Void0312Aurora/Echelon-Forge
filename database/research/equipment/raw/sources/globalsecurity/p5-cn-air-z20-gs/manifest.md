...
Estimation / uncertainty: Tier C specialist secondary source. GlobalSecurity is a long-running open-source defence compilation, not an official Chinese publication. Its rotor diameter is given as a range rather than a single value.
