...
Lifecycle: `draft`
Canonical: `database/sources/ledger/README.md`
...
Acts as the concrete data container for Source Ledger. It will hold identity, parameter, source, and future contract-mapping placeholders.
