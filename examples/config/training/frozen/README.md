...
- `leader_task_only_retrain_*`
  - derived from [p6_leader_layer_frozen_exec_generalization_v1.json](../../Archive/training/leader_legacy/p6_leader_layer_frozen_exec_generalization_v1.json)
  - adjusted to run directly on the frozen common-core substrate and target the current randomized task-only gap
- `leader_c2_retrain_*`
  - derived from [p7_leader_layer_c2_reporting_generalization_v1.json](../../Archive/training/leader_legacy/p7_leader_layer_c2_reporting_generalization_v1.json) and [p7_leader_layer_c2_reporting_generalization_fast_v2.json](../../Archive/training/leader_legacy/p7_leader_layer_c2_reporting_generalization_fast_v2.json)
