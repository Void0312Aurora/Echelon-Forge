...
export const I18N_TEXT = Object.freeze({
    en: {
        ...
        'layer.terrain.label': 'Terrain heightfield',
        'layer.terrain.short': 'TERRAIN',
        'layer.terrain.summary': 'TERRAIN',
        'layer.water.label': 'Hydrology surfaces',
        'layer.water.short': 'WATER',
        'layer.water.summary': 'WATER',
        'layer.roads.label': 'Road network',
        'layer.roads.short': 'ROADS',
        'layer.roads.summary': 'ROADS',
        'layer.buildings.label': 'Building footprints',
        'layer.buildings.short': 'BLDG',
        'layer.buildings.summary': 'BLDG',
    ...
    zh: {
        ...
        'layer.terrain.label': '地形高程',
        'layer.terrain.short': '地形',
        'layer.terrain.summary': '地形',
        'layer.water.label': '水文面',
        'layer.water.short': '水系',
        'layer.water.summary': '水系',
        'layer.roads.label': '道路网络',
        'layer.roads.short': '道路',
        'layer.roads.summary': '道路',
        'layer.buildings.label': '建筑轮廓',
        'layer.buildings.short': '建筑',
        'layer.buildings.summary': '建筑',
