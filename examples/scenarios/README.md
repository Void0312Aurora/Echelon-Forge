...
Canonical training, evaluation, diagnostic, and contract scenarios currently live under the repository-level [scenarios](/home/void0312/CMO/scenarios/README.md) directory. Keep using repo-relative `scenarios/...` paths for maintained configs, tests, and tools.
