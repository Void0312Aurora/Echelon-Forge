"""Command-code and mission-phase constants/helpers.

Canonical owner of the task-dispatch vocabulary consumed by ``gym_envs``
(scenario loading, universal-env parts, leader-env parts) and by
