        ...
        .run([](flecs::iter& it) {
            ...
            while (it.next()) {
                ...
                for (auto i : it) {
                    ...
                    double nose_x = std::cos(yaw_rad) * std::cos(pitch_rad);
                    double nose_y = std::sin(yaw_rad) * std::cos(pitch_rad);
                    double nose_z = std::sin(pitch_rad);
                    ...
                    forces[i].add_force(
                        ...
                        thrust_magnitude * nose_y,
                        thrust_magnitude * nose_z
                    );
