...
inline bool collect_scene_from_candidate_ids(
    ...
    const int viewer_side = camera_alliance != nullptr ? static_cast<int>(camera_alliance->side) : 0;
    ...
    kernel.get_world().each(
        [&](flecs::entity other_entity,
            ...
            switch (key.type) {
                case UnitType::Aircraft: object.bounding_radius = 10.0; object.cls = 0; break;
                case UnitType::Ship: object.bounding_radius = 50.0; object.cls = 2; break;
                case UnitType::Submarine: object.bounding_radius = 40.0; object.cls = 2; break;
                case UnitType::Missile: object.bounding_radius = 2.0; object.cls = 0; break;
                case UnitType::Facility: object.bounding_radius = 20.0; object.cls = 1; break;
                default: object.bounding_radius = 5.0; object.cls = 1; break;
            }
    ...
    if (out_scene->environment != nullptr) {
        (void)extract_default_environment_snapshot(
            out_scene->environment,
            &out_scene->environment_snapshot
        );
    }
    return true;
...
inline WorldBatchVisualObservationCompatibilityExport render_scenes_batch(
