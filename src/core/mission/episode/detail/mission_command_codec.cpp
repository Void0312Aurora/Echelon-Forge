...
void write_mission_command_fields_to_json(const MissionCommand& command, nlohmann::json* mission_json) {
    ...
    (*mission_json)["embarked_helo_entity_id"] = embarked_helo.embarked_helo_entity_id;
    ...
    (*mission_json)["takeoff_procedure_code"] = static_cast<int>(takeoff.takeoff_procedure_id);
    (*mission_json)["takeoff_clearance_code"] = static_cast<int>(takeoff.takeoff_clearance_id);
    (*mission_json)["takeoff_interval_s"] = takeoff.takeoff_interval_s;
    (*mission_json)["runway_slot_code"] = static_cast<int>(takeoff.runway_slot_id);
    (*mission_json)["formation_id"] = formation.formation_id;
