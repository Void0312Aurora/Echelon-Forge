...
TEST_SUITE("missile_guidance_coordinates") {
    ...
    TEST_CASE("APN rejects target acceleration radial to the line of sight") {
        ...
        const missile_guidance::Vec3 velocity_dir = missile_guidance::normalize({0.9, 0.3, 0.1});
        const missile_guidance::Vec3 radial_acceleration{los.x * 12.0, los.y * 12.0, los.z * 12.0};
    ...
    TEST_CASE("APN retains only LOS-normal target acceleration in the command plane") {
        ...
        const auto with_radial_component = missile_guidance::transverse_apn_target_acceleration(
