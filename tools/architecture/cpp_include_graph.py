...
`src/**/README.md` (see
`docs/architecture/standards/simulation_system_architecture_design.md` S15 G2
for the program-level framing). Each fine group rolls up into one of the
coarse layers named by the
