...
- [damage_model_candidate_artifacts.py](maintenance/damage_model_candidate_artifacts.py)
  - 统一的 candidate-artifact CLI，覆盖 validation scaffold、scope probe、Stage B effect-scale artifact pack、runtime authority exercise 和 candidate package bundle。
