...
| `tool_ref` | [a2_blastfrag_res003_target_geometry_closeout_gate.py]({_doc_link(repo_root / "tools" / "maintenance" / "a2_blastfrag_res003_target_geometry_closeout_gate.py", doc_output, repo_root)}) |
