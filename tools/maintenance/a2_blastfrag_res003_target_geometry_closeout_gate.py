...
| `retained_artifact` | [{output_dir.name}/res003_target_geometry_closeout_gate.json]({_display_path(output_dir / 'res003_target_geometry_closeout_gate.json', repo_root)}) |
