#!/usr/bin/env python3
"""Unified damage-model retained artifact maintenance entrypoint."""
...
def _print_help() -> None:
    print("usage: damage_model_retained_artifacts.py <command> [options]\n")
    print("Damage-model retained artifact commands:\n")
