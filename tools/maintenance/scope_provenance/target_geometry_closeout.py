...
| `tool_ref` | [damage_model_scope_provenance.py]({_doc_link(repo_root / "tools" / "maintenance" / "damage_model_scope_provenance.py", doc_output, repo_root)}) `target-geometry-closeout` |
