...
def _artifact_hash_rows(
  *,
  ...
  rows = [
   ...
   "tool_ref": "tools/maintenance/damage_model.py candidate-artifacts validation-scaffold",
   ...
   "tool_ref": "tools/maintenance/damage_model.py candidate-artifacts scope-boundary-probe",
   ...
   "tool_ref": "tools/maintenance/damage_model.py candidate-artifacts effect-scale-snapshot",
