...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--execution-step-runtime-mode", choices=["compiled", "legacy"], default=None)
    parser.add_argument("--step-info-mode", choices=["full", "terminal", "off"], default=None)
    parser.add_argument("--flight-shaping-backend", choices=["auto", "legacy", "compiled", "gpu_host"], default=None)
