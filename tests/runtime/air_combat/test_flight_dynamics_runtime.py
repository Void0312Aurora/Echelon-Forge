...
# ---------------------------------------------------------------------------
# Guards surface (subprocess-driven flight-dynamics realism guards against the
# checked-in scenario database).
# ---------------------------------------------------------------------------


def _guards_prelude() -> str:
  return dedent(
    f"""
    import json
    import os
...
# ---------------------------------------------------------------------------
# Tuning surface (subprocess-driven flight-dynamics tuning against synthesized
# airframe/engine databases).
# ---------------------------------------------------------------------------


def _tuning_prelude(db_path: str) -> str:
  return dedent(
    f"""
    import json
    import os
