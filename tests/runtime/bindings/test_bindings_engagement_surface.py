  ...
  def test_effects_event_public_fields_match_expected_binding_surface(self) -> None:
    self.assertTupleEqual(
      ...
      (
        ...
        "continuous_rod_azimuthal_sample_count",
        "continuous_rod_band_half_angle_deg",
        "continuous_rod_intersecting_azimuthal_sample_count",
        "continuous_rod_nearest_intersection_distance_m",
        "continuous_rod_polar_sample_count",
        "continuous_rod_ring_band_active",
        "continuous_rod_ring_band_intersection",
        "continuous_rod_spatial_model",
        ...
        "fragment_angular_distribution",
        "fragment_angular_distribution_active",
        ...
        "spatial_projection_effect_scale_clamped",
