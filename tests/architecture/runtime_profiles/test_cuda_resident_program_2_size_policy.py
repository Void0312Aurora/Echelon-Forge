...
def test_cr2_split_inventory_and_watch_items_match_worktree_lines() -> None:
    ...
    expected_inventory = {
        ...
        "src/tests/test_cuda_resident_replay_projection.cpp": 605,
        ...
        "src/tests/test_cuda_resident_full_window.cpp": 393,
        ...
        "src/tools/experimental/cuda_resident/cuda_resident_resource_probe.cpp": 340,
