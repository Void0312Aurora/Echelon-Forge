...
def test_cr2_split_inventory_and_watch_items_match_worktree_lines() -> None:
    ...
    expected_inventory = {
        ...
        "src/tools/experimental/cuda_resident/cuda_resident_resource_probe.cpp": 18,
        ...
        "tests/architecture/runtime_profiles/test_cuda_resident_resource_evidence.py": 433,
