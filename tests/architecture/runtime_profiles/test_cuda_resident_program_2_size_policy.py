...
def test_cr2_split_inventory_and_watch_items_match_worktree_lines() -> None:
    ...
    expected_inventory = {
        ...
        "src/runtime/contracts/cuda_resident_resource_evidence_contract.h": 90,
        "src/tools/experimental/cuda_resident/cuda_resident_resource_probe.cpp": 343,
        "tools/diagnostics/cuda_resident_cr2_resource_evidence.py": 599,
        "tools/diagnostics/cuda_resident_cr2_resource_static.py": 116,
        "tools/diagnostics/cuda_resident_cr2_json_types.py": 99,
        "tools/diagnostics/cuda_resident_cr2_resource_schema.py": 396,
        "tests/architecture/runtime_profiles/test_cuda_resident_resource_evidence.py": 432,
        "src/runtime/contracts/cuda_resident_counter_evidence_contract.h": 56,
        "tools/diagnostics/cuda_resident_cr2_counter_evidence.py": 635,
