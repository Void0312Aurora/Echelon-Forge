...
def test_cr2_split_inventory_and_watch_items_match_worktree_lines() -> None:
    ...
    expected_inventory = {
        ...
        "tools/diagnostics/cuda_resident_cr2_counter_evidence.py": 700,
        "tools/diagnostics/cuda_resident_cr2_counter_parser.py": 301,
        "tests/architecture/runtime_profiles/test_cuda_resident_counter_evidence.py": 578,
        ...
        "tools/diagnostics/cuda_resident_cp6_learner_evidence.py": 236,
