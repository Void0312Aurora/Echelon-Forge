...
def test_cr2_split_inventory_and_watch_items_match_worktree_lines() -> None:
    ...
    expected_inventory = {
        ...
        "src/runtime/contracts/cuda_resident_counter_evidence_contract.h": 73,
        "tools/diagnostics/cuda_resident_cr2_counter_evidence.py": 682,
        "tools/diagnostics/cuda_resident_cr2_counter_parser.py": 292,
        "tests/architecture/runtime_profiles/test_cuda_resident_counter_evidence.py": 530,
