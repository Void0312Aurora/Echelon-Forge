...
def test_cr2_split_inventory_and_watch_items_match_worktree_lines() -> None:
    ...
    expected_inventory = {
        ...
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_window_body.cu": 676,
        ...
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_window.cu": 66,
        ...
        "src/runtime/contracts/cuda_resident_resource_evidence_contract.h": 419,
        "src/tools/experimental/cuda_resident/cuda_resident_resource_probe.cpp": 425,
        "tools/diagnostics/cuda_resident_cr2_resource_evidence.py": 699,
        "tools/diagnostics/cuda_resident_cr2_resource_static.py": 208,
        "tools/diagnostics/cuda_resident_cr2_json_types.py": 99,
        "tools/diagnostics/cuda_resident_cr2_resource_schema.py": 489,
        "tests/architecture/runtime_profiles/test_cuda_resident_resource_evidence.py": 678,
