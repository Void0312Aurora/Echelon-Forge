...
def _scope_paths() -> list[str]:
    completed = subprocess.run(
        [
            ...
            "src/runtime/contracts/parity_budget*",
            ...
            "tools/diagnostics/cuda_resident_cp*",
        ],
        cwd=ROOT,
        check=True,
        capture_output=True,
...
def test_cr2_split_inventory_and_watch_items_match_worktree_lines() -> None:
    ...
    expected_inventory = {
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_internal.cuh": 280,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_math.cuh": 143,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_storage.cu": 558,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_barrier.cu": 264,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_control_preparation.cu": 239,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_window_body.cu": 747,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_observation.cu": 506,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_state_readback.cu": 273,
        "src/runtime/facade/internal/cuda_resident/cuda_world_store_cuda_window.cu": 79,
        "src/tests/test_cuda_resident_replay.cpp": 213,
        "src/tests/test_cuda_resident_replay_projection.cpp": 612,
        "src/tests/test_cuda_resident_replay_support.cpp": 174,
        "src/tests/test_cuda_resident_replay_support.h": 57,
        "src/runtime/contracts/cuda_resident_parity_release_contract.h": 276,
        "src/runtime/contracts/parity_budget_contracts.h": 6,
        "src/runtime/contracts/parity_budget_types.h": 221,
        "src/runtime/contracts/parity_budget_selected_slice.h": 572,
        "src/runtime/contracts/parity_budget_profiles.h": 521,
        "src/runtime/contracts/parity_budget_registry.h": 115,
        "src/runtime/contracts/cuda_resident_full_window_contract.h": 121,
        "src/runtime/facade/internal/cuda_resident/cuda_resident_full_window_runner.cpp": 256,
        "src/tools/experimental/cuda_resident/cuda_resident_full_window_probe.cpp": 331,
        "src/tests/test_cuda_resident_full_window.cpp": 394,
        ...
        "src/runtime/contracts/cuda_resident_resource_evidence_contract.h": 522,
        "src/tools/experimental/cuda_resident/cuda_resident_resource_probe.cpp": 432,
        ...
        "tools/diagnostics/cuda_resident_cr2_counter_evidence.py": 699,
        "tools/diagnostics/cuda_resident_cr2_counter_parser.py": 324,
        "tests/architecture/runtime_profiles/test_cuda_resident_counter_evidence.py": 601,
        "src/runtime/contracts/cuda_resident_matrix_contract.h": 107,
        "src/tools/experimental/cuda_resident/cuda_resident_cr2_matrix_session.h": 56,
        "src/tools/experimental/cuda_resident/cuda_resident_cr2_matrix_session.cpp": 292,
        "src/tools/experimental/cuda_resident/cuda_resident_cr2_matrix_probe.cpp": 501,
        "tools/diagnostics/cuda_resident_cr2_matrix_probe.py": 603,
        "tools/diagnostics/cuda_resident_cp6_learner_evidence.py": 329,
        ...
        "tests/architecture/runtime_profiles/test_cuda_resident_cr2_matrix_evidence.py": 389,
        ...
        "tests/architecture/runtime_profiles/test_cuda_resident_cp9_promotion_decision.py": 165,
    }
