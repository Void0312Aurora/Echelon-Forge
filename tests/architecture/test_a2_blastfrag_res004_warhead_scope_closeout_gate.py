...
from tools.maintenance import (  # noqa: E402
    a2_blastfrag_res004_warhead_scope_closeout_gate as gate,
)


def test_res004_warhead_scope_closeout_closes_stage_b_family_scope_only() -> None:
    artifact = gate.generate_res004_warhead_scope_closeout_gate(repo_root=REPO_ROOT)
    ...
    assert decision["stage_b_effect_scale_warhead_family_scope_closeout_complete"] is True
...
def test_res004_warhead_scope_closeout_keeps_authority_guards_false() -> None:
    artifact = gate.generate_res004_warhead_scope_closeout_gate(repo_root=REPO_ROOT)
...
def test_res004_warhead_scope_closeout_fails_closed_without_evidence(
    tmp_path: Path,
) -> None:
    artifact = gate.generate_res004_warhead_scope_closeout_gate(
        repo_root=tmp_path,
...
def test_res004_warhead_scope_closeout_cli_writes_retained_json_and_doc(
    tmp_path: Path,
) -> None:
