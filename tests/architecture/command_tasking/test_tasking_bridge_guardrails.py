...
def test_policy_state_reads_route_maintained_loader_owned_seam() -> None:
  ...
  assert "def get_policy_agent_observation(loader: Any, agent_id: Any | None = None) -> Any:" in bridge_text
  assert "def get_policy_instrument_state(loader: Any, agent_id: Any | None = None) -> Any:" in bridge_text
