...
def test_release_signoff_gate_fails_closed_for_incomplete_payload(
  ...
  bad_source_manifest = write_release_json(tmp_path / "source_manifest.json", source_manifest)
...
def test_release_signoff_gate_fails_closed_for_raw_comparison_value(
  ...
  bad_mechanism = write_release_json(tmp_path / "mechanism_comparison_hashes.json", mechanism)
