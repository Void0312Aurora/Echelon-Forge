...
def test_source_payload_pack_current_repo_is_partial(
    tmp_path: Path,
) -> None:
...
def test_source_payload_pack_rejects_hash_mismatch(
    tmp_path: Path,
) -> None:
...
def test_source_rights_output_policy_current_repo_is_blocked_release_candidate(
    tmp_path: Path,
) -> None:
